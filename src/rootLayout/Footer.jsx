...
export default function Footer() {
  return (
    ...
    >
      ...
      >
        ...
        >
          ...
          <div className="flex items-center gap-3 mt-5">
            <div
              className="h-px w-8"
              style={{ background: "rgba(255,190,60,0.25)" }}
            />
            <p
          ...
          <div
            className="mt-6"
            style={{
              borderLeft: "1px solid rgba(255,190,60,0.15)",
              paddingLeft: "1rem",
            }}
          >
            <p
          ...
          <div className="flex flex-col gap-2">
            {QUICK_LINKS.map((link) => (
              <button
                ...
                onMouseEnter={(e) =>
                  (e.currentTarget.style.color = "rgba(255,190,60,0.8)")
                }
                onMouseLeave={(e) =>
          ...
          <div className="flex flex-col gap-4">
            <div>
              ...
              <a
                ...
                onMouseEnter={(e) =>
                  (e.target.style.color = "rgba(255,190,60,0.8)")
                }
                onMouseLeave={(e) =>
      ...
      <div
        style={{
          borderTop: "1px solid rgba(255,190,60,0.07)",
          padding: "1.25rem clamp(1.5rem, 6vw, 8vw)",
        }}
      ...
      >
        ...
        <div className="flex items-center gap-2">
          ...
          <a
            ...
            onMouseEnter={(e) =>
              (e.target.style.color = "rgba(255,190,60,0.9)")
            }
            onMouseLeave={(e) =>
              (e.target.style.color = "rgba(255,190,60,0.45)")
            }
          >
            Fahim
          </a>
          <span style={{ fontSize: "0.5rem", color: "rgba(255,190,60,0.25)" }}>
            &
          </span>
          <a
