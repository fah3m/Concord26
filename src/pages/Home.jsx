      ...
      >
        ...
        >
          ...
          >
            <div
              style={{
                ...
                height: "1px",
                background:
                  "linear-gradient(to right, transparent, rgba(255,190,60,0.5))",
              }}
            />
            ...
            <div
              style={{
                ...
                height: "1px",
                background:
                  "linear-gradient(to left, transparent, rgba(255,190,60,0.5))",
              }}
            />
          </motion.div>
          ...
          <motion.div className="flex items-center gap-8" {...fadeUp(0.5, 10)}>
            <div>
              <p
                className="font-main text-[0.52rem] tracking-[0.4em] uppercase mb-1.5 font-bold"
                style={{ color: "rgba(255,190,60,0.4)" }}
              >
                Date
              </p>
              <p
                className="font-main text-[0.82rem] tracking-[0.1em] font-bold"
            ...
            <div>
              ...
              <p
                className="font-main text-[0.82rem] tracking-[0.1em] uppercase font-bold"
                style={{ color: "rgba(255,255,255,0.55)" }}
              >
                XXVI
              </p>
        ...
        >
          <p
            className="font-main text-[0.55rem] tracking-[0.4em] uppercase font-bold"
        ...
        >
          ...
          <motion.div
            ...
            {...fadeUp(0.05, 10)}
          >
            <span className="font-main text-[0.55rem] tracking-[0.35em] uppercase text-amber-500/55 font-bold">
              Annual Fest
            </span>
            <span className="font-main text-[0.55rem] tracking-[0.25em] uppercase text-white/25 font-bold">
              Issue XXVI
            </span>
          </motion.div>
          ...
          <motion.div className="flex items-center gap-3" {...fadeIn(0.35)}>
            <div
              ...
              style={{
                background:
                  "linear-gradient(to right, transparent, rgba(255,190,60,0.35))",
              }}
            />
            <svg width="8" height="8" viewBox="0 0 10 10" fill="none">
              <rect
            ...
            <div
              ...
              style={{
                background:
                  "linear-gradient(to left, transparent, rgba(255,190,60,0.35))",
              }}
            />
          </motion.div>
          ...
          >
            <div className="text-center">
              <p className="font-main text-[0.48rem] tracking-[0.38em] uppercase text-amber-400/38 mb-1 font-bold">
                Date
              </p>
              <p className="font-main text-[0.72rem] tracking-[0.06em] uppercase text-white/55 font-bold">
                July 1-3, 2026
              </p>
            </div>
            <span
            ...
            <div className="text-center">
              ...
              <p
                className="font-bold text-[0.72rem] text-white/55"
                style={{ ...cbs, letterSpacing: "0.04em" }}
              >
                CBS Campus
              </p>
            </div>
          ...
          <motion.div className="flex items-center gap-3" {...fadeIn(0.6)}>
            <div
              ...
              style={{
                background:
                  "linear-gradient(to right, transparent, rgba(255,190,60,0.2))",
              }}
            />
            <div
              style={{
            ...
            <div
              ...
              style={{
                background:
                  "linear-gradient(to left, transparent, rgba(255,190,60,0.2))",
              }}
            />
          </motion.div>
        </div>
